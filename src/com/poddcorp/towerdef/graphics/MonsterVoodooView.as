package com.poddcorp.towerdef.graphics
{
	...
	public class MonsterVoodooView extends Sprite implements ITileView
	{
		...
		{					
			...
			movingSouth = new MovieClip(UIAssets.getAtlas().getTextures("Vodoodoll_BACK_NE"), 20);
			movingSouthEast = new MovieClip(UIAssets.getAtlas().getTextures("Vodoodoll_SE"), 20);
			movingSouthWest = new MovieClip(UIAssets.getAtlas().getTextures("Vodoodoll_SW"), 20);
