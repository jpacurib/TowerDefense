package com.poddcorp.towerdef.graphics
{
	...
	public class MonsterView extends Sprite implements ITileView
	{
		...
		{		
			...
			movingNorth = new MovieClip(UIAssets.getAtlas().getTextures("img_Coin"), 20);
			movingNorthEast = new MovieClip(UIAssets.getAtlas().getTextures("img_Coin"), 20);
			movingNorthWest = new MovieClip(UIAssets.getAtlas().getTextures("img_Coin"), 20);
			movingSouth = new MovieClip(UIAssets.getAtlas().getTextures("img_Coin"), 20);
			movingSouthEast = new MovieClip(UIAssets.getAtlas().getTextures("img_Coin"), 20);
			movingSouthWest = new MovieClip(UIAssets.getAtlas().getTextures("img_Coin"), 20);
			
			movingEast = new MovieClip(UIAssets.getAtlas().getTextures("img_Coin"), 20);
			movingWest = new MovieClip(UIAssets.getAtlas().getTextures("img_Coin"), 20);
